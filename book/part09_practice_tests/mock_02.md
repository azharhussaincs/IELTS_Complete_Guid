...
Consider a programme evaluated solely by short-term participation numbers. Attendance may rise because events are entertaining, yet long-term capability related to digital privacy might not improve. A richer evaluation mix could include retention, transfer of skills, equity of access, and unintended consequences. Mixed-methods designs — combining statistics with interviews — are increasingly recommended precisely because digital privacy sits at the intersection of behaviour, technology, and institutions.
